...
#include "stanExports_fix_samecv.h"

RCPP_MODULE(stan_fit4fix_samecv_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_fix_samecv")
